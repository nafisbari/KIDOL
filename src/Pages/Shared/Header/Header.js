        ...
        <div className=' bg-white overflow-hidden py-4  md:pb-12 relative '>
            <nav className="flex items-center justify-between flex-wrap bg-teal-500 p-6">
                ...
                <div className="block lg:hidden">
                    <button className="flex items-center px-3 py-2 border rounded font-bold font-rubik text-teal-200 border-teal-400 hover:text-white hover:border-white">
                    ...
                    <div>
                        {
                            user?.email ?
                                <><div className="inline-block leading-none flex items-center justify-end">
                                    ...
                                    <button
                                        className="inline-block bg-colorPink hover:bg-colorBlue text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline transition ease-in-out duration-700 font-bold font-rubik"
