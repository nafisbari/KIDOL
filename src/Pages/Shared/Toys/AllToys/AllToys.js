            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-4 gap-y-12">
                {
                    toys.map(toy =>
                        <div className="w-11/12 mx-auto   px-8 py-12 bg-colorToys h-full rounded">
                            ...
                            <button
                                className="bg-colorPink hover:bg-colorBlue text-white hover:text-colorGray font-bold py-2 px-4 mt-8 mb-8 rounded-xl focus:outline-none focus:shadow-outline w-1/2 transition ease-in-out duration-700"
                                type="submit">
                                Buy Now
                            </button>
