...
const Toy = ({ toy }) => {
    const { _id, name, img, price, shortDesc, review } = toy;
            ...
            <div className="w-11/12 mx-auto   px-8 py-12 bg-colorToys h-full rounded">
                ...
                <div>
                    ...
                    <Link to={`/toyDetails/${_id}`}><button
                        className="bg-colorPink hover:bg-colorBlue text-white hover:text-colorGray font-bold py-2 px-4 my-4 mb-12 rounded-xl focus:outline-none focus:shadow-outline w-1/2 transition ease-in-out duration-700 font-rubik"
                        type="submit">
                        Buy Now
                    </button></Link>
                </div>
